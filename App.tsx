...
const MOCK_PROPERTIES: Property[] = [
  { id: 'prop-1', name: 'StaySync Resort', location: 'Miami, FL', totalRooms: 250 },
  { id: 'prop-2', name: 'StaySync City Suites', location: 'New York, NY', totalRooms: 120 },
  { id: 'prop-3', name: 'StaySync Alpine Lodge', location: 'Aspen, CO', totalRooms: 85 },
];

const MOCK_USER: User = {
  id: 'u-admin-1',
  name: 'Alex Johnson',
  email: 'alex@staysync.com',
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      >
        ...
        {activeTab === 'dashboard' && <Dashboard key={isDemoMode ? 'demo' : 'prod'} property={currentProperty} isDemoMode={isDemoMode} user={user} />}
